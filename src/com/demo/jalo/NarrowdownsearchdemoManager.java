...
import com.demo.constants.NarrowdownsearchdemoConstants;
 ...
 */
public class NarrowdownsearchdemoManager extends GeneratedNarrowdownsearchdemoManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(NarrowdownsearchdemoManager.class.getName());
	 ...
	 */
	public static NarrowdownsearchdemoManager getInstance()
	{
		return (NarrowdownsearchdemoManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(NarrowdownsearchdemoConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public NarrowdownsearchdemoManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of NarrowdownsearchdemoManager called.");
		}
	}
